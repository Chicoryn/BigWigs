...
local dataBroker = ldb:NewDataObject("BigWigs",
	{type = "launcher", label = "BigWigs", icon = "Interface\\AddOns\\CherWigs\\Media\\Textures\\icons\\core-disabled"}
)
...
function mod:ADDON_LOADED(addon)
	if addon ~= "CherWigs" then return end
...
function mod:BigWigs_CoreEnabled()
	dataBroker.icon = "Interface\\AddOns\\CherWigs\\Media\\Textures\\icons\\core-enabled"
...
function mod:BigWigs_CoreDisabled()
	dataBroker.icon = "Interface\\AddOns\\CherWigs\\Media\\Textures\\icons\\core-disabled"
end
